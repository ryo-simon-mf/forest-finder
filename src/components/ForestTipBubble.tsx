...
const TIPS = [
  '森林浴はストレスホルモンを13％減らします',
  '週2回、20分以上の森林滞在が勧められています',
  '国立公園は全国に35ヵ所。東京に森林は6000以上',
  'カナダでは、森の滞在を医師が処方します',
  '森の香り成分フィトンチッドは免疫力を高めます',
  '日本の国土の約67％は森林で覆われています',
  '森林は1haあたり年間約10トンのCO₂を吸収します',
  '緑の多い環境は血圧を平均5mmHg下げる効果があります',
]
